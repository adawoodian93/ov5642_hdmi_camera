...
REM
REM Generated by Vivado on Fri Aug 02 00:53:40 -0700 2024
...
echo "xvlog --incr --relax -prj tb_debounce_reset_vlog.prj"
call xvlog  --incr --relax -prj tb_debounce_reset_vlog.prj -log xvlog.log
