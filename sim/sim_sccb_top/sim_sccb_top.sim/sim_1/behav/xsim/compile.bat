...
REM
REM Generated by Vivado on Mon Aug 19 00:39:39 -0700 2024
...
echo "xvlog --incr --relax -prj tb_sccb_top_vlog.prj"
call xvlog  --incr --relax -prj tb_sccb_top_vlog.prj -log xvlog.log
